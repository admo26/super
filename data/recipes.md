...
## Bolognese Sauce (Annabel Langbein)
source: https://www.langbein.com/recipes/bolognese-sauce
cook_frequency: monthly_batch
serving_pattern: used_weekly_with_pasta
rotation_notes: Make roughly once per month, then serve weekly with pasta from batch/frozen portions.
...
- parmesan or cheese (optional)

## Roast Chicken Dinner
source: family standard meal
cook_frequency: weekly
serving_pattern: same_week_meal
rotation_notes: Weekly roast chicken dinner.

ingredients_to_map:
- Tegel Free Range Oven Ready Sage & Onion Roast Fresh Chicken (1)
...
ingredients_to_map:
- chicken thighs
- butter chicken curry paste or spice blend
...
cook_frequency: weekly
serving_pattern: same_week_meal
rotation_notes: Weekly fajitas are a fixed meal anchor.
...
- garlic
- pineapple pieces
- sweet and sour sauce ingredients or jar sauce
- rice
- cornflour (optional, for coating)
...
- carrot
- capsicum
- protein of choice (chicken/pork/beef/tofu)
- sesame oil (optional)
...
- hokkien noodles or similar noodles
- brown onion
- garlic
- choy sum or other Asian greens
- soy sauce
- dark soy sauce
- oyster sauce
...
- spring onion
- sesame seeds
- cucumber or Asian greens (optional side)
...
- broccoli, broccolini, green beans or spinach (optional veg add-in/side)
